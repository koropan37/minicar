...
class StateController:
    ...
    def _handle_emergency(self, L, FL, C, FR, R, pattern):
        ...
        if pattern['right_s_curve']:
            ...
            # 近い壁から遠ざかる
            avoid_direction = SERVO_LEFT if R < L else SERVO_RIGHT
