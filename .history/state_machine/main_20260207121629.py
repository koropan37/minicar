...
CONTROL_INTERVAL = getattr(cfg, "CONTROL_INTERVAL", 0.04)
DEBUG_PRINT_INTERVAL = getattr(cfg, "DEBUG_PRINT_INTERVAL", 1)
ENABLE_DEBUG_LOG = getattr(cfg, "ENABLE_DEBUG_LOG", True)
