...
from modules.potential_controller import PotentialController


class MiniCarPotential:
    """ポテンシャル法走行のメインクラス"""
    
    def __init__(self):
        print("=" * 50)
        print("仮想ポテンシャル法走行システム")
        print("障害物からの反発力で走行")
        print("=" * 50)
        ...
        self.controller = PotentialController()
